...
%%
\newML{Title}{Reykjavík University Project Report, Thesis, and Dissertation Template}{Herkænsku mat á djúptauganetum}
\newML{TITLE}{REYKAJVÍK UNIVERSITY PROJECT REPORT, THESIS, AND DISSERTATION TEMPLATE}{Strategy evaluation of deep learning models}
%%
...
\newML{keywords}{Model Interpretation, Reinforcement Learning, Deep Learning}{Lykliorð1, Lykliorð2, Lykliorð3}
...
\include{sections/introduction}%%RUM: Introduction
\include{sections/background}%%RUM: Background

%\part{The Second Part}

This part of the dissertation describes the work done.

\include{sections/methods}%%RUM: "Methods"
\include{sections/results}%%RUM: "Results"

%\part{The Third Part}

This part of the dissertation talks about future work discussion concludes the work and 

\include{sections/discussion}%%RUM: "Discussion"
