...
class BTBoard(Node):
    def __init__(self, board_list, player_turn):
        ...
        self.children = self.get_children_helper()
    ...
    def get_children_helper(self) -> set:
        children = set()
...
def play_game(white_think, black_think):
  ...
  board = BTBoard(startBoard, BREAKTHROUGHWHITE)
  while True:
    ...
    if board.terminal:
        break
  return BTBoard.reward()

print(play_game(10,10))
